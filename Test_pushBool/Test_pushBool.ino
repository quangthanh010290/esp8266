...
void pushFirebaseBoll(const String path, bool _data) {
	Firebase.pushBool(path, _data);
	if (Firebase.failed()) 
	{
	...
	{
		Serial.print("Push Bool Success,data writen:");
...
void loop() {
	pushFirebaseBoll("123/states/004",true);
	delay(500);
}
